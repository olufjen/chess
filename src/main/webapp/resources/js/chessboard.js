...
//------------------------------------------------------------------------------
// Stateful
// Mine kommentarer: widget er et tomt objekt.
//------------------------------------------------------------------------------
  ...
  if (typeof containerElOrId === 'string') {
    ...
    if (containerElOrId === '') {
      window.alert('ChessBoard Error 1001: ' +
        'The first argument to ChessBoard() cannot be an empty string. yyy' +
        '\n\nExiting...');
      return false;
    }
...
function expandConfig() {
  ...
  if (cfg.hasOwnProperty('pieceTheme') !== true ||
    ...
    cfg.pieceTheme = '/chess_web/resources/img/chesspieces/wikipedia/{piece}.png';
  }
...
//  removeSquareHighlights(); call removed OJN 13.07.23 to keep the last move highlighted
  ...
  // set state
  DRAGGING_A_PIECE = false;
//  window.alert('ChessBoard brikke på brettet '+DRAGGED_PIECE);
  console.log( "ChessBoard brikke på brettet brett submitted x"+DRAGGED_PIECE );
  formSubmit('btnmove');
...
function stopDraggedPiece(location) {
  ...
  var action = 'drop';
  console.log( "ChessBoardstopDraggedPiece "+location );
