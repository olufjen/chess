...
public class PlayGame {
  ...
  /**
   *  The original HashMap of positions
   */
  ...
  /**
   *  The original HashMap of positions as a list
   */
  private List<Position> positionlist;

  private no.chess.web.model.AchessGame game;

  private ChessBoard myFrontBoard;

  private no.games.chess.ChessState currentState;

  private List<no.chess.web.model.ApieceMove> movements;
  ...
  /**
   *  Is the active state of the game; a node in the game tree
   */
  private no.chess.web.model.ChessStateImpl activeState;

  private no.chess.web.model.AChessAgent chessAgent =  null;

  private no.chess.web.model.ChessKnowledgeBase kb =  null;
...
//		kb = new ChessKnowledgeBase();
  ...
  public List<no.chess.web.model.ApieceMove> getMovements() {
		return movements;
  }
  ...
  public no.chess.web.model.AchessGame getGame() {
		return game;
  }

  public void setGame(no.chess.web.model.AchessGame game) {
		this.game = game;
  }
...
//		notusedPositions = (List<Position>) ((List<Position>) positions).stream().filter(board.queenExistsAt(position.getXyloc())).collect(Collectors.toList());
  ...
  public no.chess.web.model.ChessStateImpl getActiveState() {
		return activeState;
  }

  public void setActiveState(no.chess.web.model.ChessStateImpl activeState) {
...
//available positions calculated		
   ...
   * @param playerTomove
   */
  private void verifyAction(no.chess.web.model.ChessActionImpl action, no.chess.web.model.AgamePiece piece, Position position, no.chess.web.model.APlayer playerTomove) {
...
//			return evaluation;
   ...
   */
  public void createMove(no.chess.web.model.AgamePiece piece, Position from, Position to, List<ApieceMove> moves) {
		int noofMoves = 0;
...
//		piece.getLegalmoves(to); // Create a new list of available position after move 
   ...
   * @param to The to Position
   */
  public void createMove(no.chess.web.model.AgamePiece piece, Position from, Position to) {
		int noofMoves = 0;
		String algebraicmove = "";
